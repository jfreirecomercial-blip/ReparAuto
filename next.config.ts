...
const cspDirectives = [
  ...
  // api.country.is: first-visit GeoIP market detection. brasilapi.com.br: FIPE brands/models for Brazilian listings.
  `connect-src 'self' ${FIREBASE_HOSTS.join(' ')} ${GOOGLE_ADS_HOSTS.join(' ')} wss://*.firebaseio.com https://*.tile.openstreetmap.org https://api.country.is https://brasilapi.com.br`,
