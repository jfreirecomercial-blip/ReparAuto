...
export const TEXTOS_POLITICAS = {
  ...
  cookies: {
    ...
    corpo: `
      ...
      <p class='mb-4'>A RecarGarage utiliza tecnologias estritamente necessárias ao funcionamento da plataforma e, <strong>mediante o seu consentimento prévio</strong>, cookies de marketing e publicidade fornecidos pelo Google Ads. Estes últimos só são instalados após aceitação expressa no banner de cookies e podem ser recusados ou revogados a qualquer momento nas Definições de Privacidade.</p>
      ...
      <table class='w-full mb-4 text-sm border-collapse border border-slate-300'>
        ...
        <tbody>
          ...
          <tr><td class='border border-slate-300 p-2'>Marketing (mediante consentimento)</td><td class='border border-slate-300 p-2'>Google Ads (gtag.js) — _gcl_*, cookies de conversão e remarketing</td><td>Medir a eficácia dos anúncios (conversões) e apresentar remarketing noutros sites. Instalados apenas após consentimento expresso.</td><td class='border border-slate-300 p-2'>Até 90 dias (configuração Google)</td></tr>
        </tbody>
      </table>

      <p class='font-bold text-slate-800 mb-2'>3. Serviços de Terceiros</p>
      <p class='mb-4'>A RecarGarage utiliza o <strong>Firebase</strong> (Google LLC) como plataforma de backend. O Firebase pode definir cookies de sessão estritamente necessários para a autenticação e segurança. Mediante o seu consentimento, utilizamos ainda o <strong>Google Ads</strong> (Google Ireland Ltd.) para medição de conversões e remarketing, com o <strong>Google Consent Mode v2</strong> ativo — ou seja, na ausência de consentimento, o Google não armazena identificadores publicitários. A Google dispõe de Certified SCCs (Standard Contractual Clauses) para transferências internacionais de dados, e os seus data centers na União Europeia garantem a conformidade com o RGPD.</p>

      <p class='font-bold text-slate-800 mb-2'>4. Base Jurídica e Consentimento</p>
      <p class='mb-4'>Nos termos do art. 5.º, n.º 3, da Diretiva 2002/58/CE (transposta pela Lei n.º 46/2012), os cookies e tecnologias de armazenamento local <strong>estritamente necessários</strong> ao funcionamento da plataforma estão isentos de consentimento prévio. As restantes tecnologias, incluindo os cookies analíticos e de marketing/publicidade, só são instaladas após <strong>consentimento expresso</strong> (opt-in) através do banner de cookies. Enquanto não der esse consentimento, estas tecnologias permanecem desativadas. Pode alterar ou revogar as suas escolhas a qualquer momento nas Definições de Privacidade, no rodapé do site.</p>
